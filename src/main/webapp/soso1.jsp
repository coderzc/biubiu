...
<div id="input-group input-group-lg" style="position: relative;top: 15px;">
    ...
    <div id="logo_input">
        ...
        <div id="serarch_button">
            <a id="search_soso"
               onclick="soso($('#search input').val())"
               class="button button-glow button-rounded button-raised button-primary">搜索</a>
        </div>
    </div>
    <div id="nav_sub">
        <ul class="wrap">
    ...
    <div id="page_result" class="so_wrap" style="position: relative">
        <div class="so_info">
            <p class="so_info_total">共${pageModel.recordCount}条数据</p>
        </div>
    ...
    <div class="bottom" style="text-align: center">
        <ul class="pagination " id="page_plugin" style="cursor: pointer">
            ...
            <c:forEach begin="1" end="${pageModel.pageSize}" var="x">
                <li class="normal active pageNo_li"><a id="passage${x}">${x}</a></li>
            </c:forEach>
